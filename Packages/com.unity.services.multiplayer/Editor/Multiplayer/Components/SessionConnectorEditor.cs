...
namespace Unity.Services.Multiplayer.Editor.Components
{
    ...
    class SessionConnectorEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var quickJoinOptionsProp = so.FindProperty("m_QuickJoinSettings");
            var quickJoinFields = new PropertyField(quickJoinOptionsProp);
            operationFoldout.Add(quickJoinFields);
            ...
            SerializedProperty operationProp)
        {
            ...
            var isQuickJoin = operation == SessionConnectorType.QuickJoin;

            var showCreateAndNetwork = isCreate || isCreateOrJoin || isQuickJoin;
            ...
            quickJoinFields.EnableInClassList(k_HiddenClass, !isQuickJoin);
